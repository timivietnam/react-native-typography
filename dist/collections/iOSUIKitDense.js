...
var getStylesForColor = function getStylesForColor(color) {
  ...
  return {
    largeTitleEmphasized: _extends(
      ...
      { letterSpacing: _reactNative.Platform.OS === "ios" ? 0.41 : undefined }
    ),
    ...
    title3Emphasized: _extends(
      ...
      { letterSpacing: _reactNative.Platform.OS === "ios" ? 0.75 : undefined }
    ),
    ...
    subheadEmphasized: _extends(
      ...
      _humanDense2.default["subhead" + colorSuffix + "Object"],
      _systemDenseWeights2.default.semibold,
      { letterSpacing: _reactNative.Platform.OS === "ios" ? -0.24 : undefined }
    ),
    ...
    footnoteEmphasized: _extends(
      ...
      _systemDenseWeights2.default.semibold,
      { letterSpacing: _reactNative.Platform.OS === "ios" ? -0.08 : undefined }
    ),
    ...
    caption2Emphasized: _extends(
      ...
      _systemDenseWeights2.default.semibold,
      { letterSpacing: _reactNative.Platform.OS === "ios" ? 0.06 : undefined }
    )
  };
};
